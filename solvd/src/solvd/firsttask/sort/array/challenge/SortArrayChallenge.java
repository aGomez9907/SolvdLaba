package solvd.firsttask.sort.array.challenge;
...
public class SortArrayChallenge {
    ...
    public static void main(String[] args){
        final int ARRAY_LENGTH = 5;//calling the method to enter the numbers for the array and declaring the array length
        printArray(sortArray(getArray(ARRAY_LENGTH)));//ordering and printing the array
    }
